...
import 'package:sakani_mobile_app/app/data/local_data/setting_app_service.dart';
...
//        static const RETURN_REQ_ =;
  ...
  static const PRODUCT_BTN_UPDATECART = 'shoppingcart.updatecart';
  ...
  static const LOCATION = "address.fields.location";
  ...
  static const DELETE_ACCOUNT = "nopstation.webapi.account.deleteaccount";
  static const DELETE_ACCOUNT_DIALOG_TITLE =
      "nopstation.webapi.account.deleteaccountdialogtitle"; // "Confirm Account Deletion"
  static const DELETE_ACCOUNT_DIALOG_BODY =
      "nopstation.webapi.account.deleteaccountdialogbody"; // "This action can not be revoked.\nAre you sure?"
  static const DELETE_ACCOUNT_PASSWORD_DIALOG_TITLE =
      "nopstation.webapi.account.deleteaccountpassworddialogtitle"; // "Password"
  static const DELETE_ACCOUNT_PASSWORD_DIALOG_BODY =
      "nopstation.webapi.account.deleteaccountpassworddialogbody"; // "Enter your password"
  //static const COMMON_CANCEL = "nopstation.webapi.common.cancel" // Cancel
  ...
  static const STORE_CLOSED = "storeclosed";
  static const STORE_CLOSED_HINT = "storeclosed.hint";

//force update Strings
  static const FORCE_UPDATE_EXIT_BTN =
      "nopstation.webapi.forceupdatedialogbutton.exit"; // Exit
  static const FORCE_UPDATE_UPDATE_BTN =
      "nopstation.webapi.forceupdatedialogbutton.update"; // Update
  static const FORCE_UPDATE_TITLE =
      "nopstation.webapi.forceupdatedialog.title"; // A newer version is available
  static const FORCE_UPDATE_CONTENT =
      "nopstation.webapi.forceupdatedialog.content"; // Please Update Your App
  static const FORCE_UPDATE_FAILURE =
      "nopstation.webapi.forceupdatefailuremessage"; // Can't launch the updater. Please update manually
}

extension AppStringsTr on String? {
  String get translate {
    if (isNullOrEmpty) {
      return 'unknown word';
    }
    return Get.find<AppSettingService>().appLandingData?.translateMap[this] ??
        this!.tr;
  }

  String getStringWithNumber(int value) =>
      translate.replaceFirst("{0}", value.toString());

  String getStringWithNumberStr(String value) =>
      translate.replaceFirst("{0}", value);
}
