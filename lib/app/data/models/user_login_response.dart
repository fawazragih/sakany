...
class UserLoginData {
  ...
  factory UserLoginData.fromJson(Map<String, dynamic> json) => UserLoginData(
        ...
        basUserInfo: json["basUserInfo"] == null
            ? null
            : BasUserInfo.fromJson(json["basUserInfo"]),
        needToRegister: json["needToRegister"],
        token: json["Token"],
      );

  Map<String, dynamic> toJson() => {
        "CustomerInfo": customerInfo?.toJson(),
        "basUserInfo": basUserInfo?.toJson(),
...
class BasUserInfo {
  ...
  factory BasUserInfo.fromJson(Map<String, dynamic> json) => BasUserInfo(
        openId: json["open_id"],
...
class CustomerInfo {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "AssociatedExternalAuthRecords": associatedExternalAuthRecords != null
...
class CustomerAttribute {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "Values":
            values != null ? List<dynamic>.from(values!.map((x) => x)) : null,
        "Id": id,
        "CustomProperties": customProperties?.toJson(),
      };
}
